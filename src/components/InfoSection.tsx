      ...
      <CardContent className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-2">
            ...
            <h3 className="font-semibold text-base text-foreground">Verified Medical Info</h3>
          ...
          <div className="space-y-2">
            ...
            <h3 className="font-semibold text-base text-foreground">Regular Updates</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-2">
            ...
            <h3 className="font-semibold text-base text-foreground">Privacy Focused</h3>
            <p className="text-sm text-muted-foreground">
        ...
        <div className="mt-8 pt-6 border-t border-border text-center">
          <p className="text-sm text-muted-foreground max-w-3xl mx-auto">
            <strong className="text-primary">Important:</strong> MediAssist AI provides general health information for educational purposes. 
